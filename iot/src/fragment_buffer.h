...
int fragment_update_message(struct fragment_buffer* buf, struct srtp_packet* msg, uint32_t max_data);
/* Fills in the data in the update message with the next fragment data */
int generate_update_messages(struct fragment_buffer* buf, struct srtp_packet* msg);
