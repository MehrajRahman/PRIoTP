...
enum MESSAGE_STATUS handle_fragmentation(struct transport* transport, struct srtp_packet* upd_msg)
{
...
int transport_receive(struct transport* transport, struct srtp_packet** msg,
